...
const SpecializeTrack = () => {
    ...
    return (
        <section>
            <Wrapper>
                {/* header */}
                <div> <h2 className="text-4xl  font-bold leading-[55px] whitespace-pre-line">Specialized Tracks:</h2>
                ...
                <div className="flex mt-10 gap-x-6 gap-y-8 flex-col-reverse md:flex-row">
                    ...
                    <div className="bg-white sticky top-36 self-start basis-8/12 shadow-xl border rounded-xl border-slate-300 py-8 px-6 ">
                        <h4 className="text-teal-700  font-medium mt-6 lg:mt-0">
                            Specialized Track
                        </h4>
                        <h2 className="font-bold text-2xl">{selecteditemdata?.header}</h2>
                        <p className="text-lg mt-3 text-neutral-700">{selecteditemdata?.desc}</p>
                        <Link href={"https://www.piaic.org/"}><button className="bg-[#00616C] text-white px-6 py-3 hover:shadow-lg font-medium
                            rounded-full text-xl hover:scale-105 duration-300 flex items-center gap-x-2">Learn More
